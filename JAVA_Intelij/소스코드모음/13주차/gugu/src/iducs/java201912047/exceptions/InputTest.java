...
public class InputTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            // MyException 이런걸 checked exception 이라고 함   ArrayTest에 있는건 언체크드 리셉션임
...
class MyException extends Exception{ // Exception 클래스를 상속받은 클래스(단, RuntimeException을 상속받은 경우 제외
    // unchecked exception 는 트라이 케치 안해도 되고 checked exception 반드시 체크해줘야함
